...
%		All security assumptions in the user space are invalid from this point.
	...
	\chapter{Evaluation}
		...
		A breakdown on which drivers is used for what reason or device is shown in table \ref{driver_selection}. \citep{xhci}
		...
		\begin{table}[]
			...
			\begin{tabular}{ll}
				...
				&       
			\end{tabular}
			\caption{X260 hardware \citep{x260}}
		...
		\begin{table}[]
			...
			\begin{tabular}{ccccccccc}
				& Timer & IO\_PORT & IO\_MEM & IRQ & Platform & P(IO\_PORT) & P(IO\_MEM) & P(IRQ) \\
				platform\_drv &       & x        &         &     &          &             &            &        \\
				acpi\_drv     &       &          & x       &     &          &             &            &        \\
				fb\_boot\_drv & x     &          & x       &     &          &             &            &        \\
				rtc\_drv      &       & x        &         &     &          &             &            &        \\
				usb\_drv      & x     &          &         &     & x        & x           & x          & x      \\
				intel\_fb     & x     &          & x       &     & x        & x           & x          & x      \\
				ahci\_drv     & x     &          & x       &     & x        & x           & x          & x      \\
				fb\_drv       & x     & x        & x       &     & x        & x           &            &        \\
				nic\_drv      & x     &          &         &     & x        & x           & x          & x     
			\end{tabular}
		...
		Table \ref{drivers} shows the dependencies of each driver in Genode.
