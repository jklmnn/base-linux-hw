...
<platform_info>
	...
	<boot>
		...
		On micro kernel based scenarios this information is collected and provided by the kernel.
	...
	\chapter{Conclusion}
		...
		Also the performance of this approach needs to be evaluated.
		...
		The Linux Kernel Tinification project \citep{tiny} done some work in that direction.
