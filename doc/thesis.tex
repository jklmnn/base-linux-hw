...
\begin{document}
	...
	\chapter{State of the art}
		...
		The virtualized calls access services provided by the host operating system such as network interfaces and protocols.
		For hardware drivers the physical hypercalls are more interesting.
		While those are referenced in the platforms description where also bare hardware is mentioned as a supported platform there was no reference to the actual hypercall API for physical operations. \citep{rump_man} \citep{rump_platform}
